!(function e(t, r, o) {
	...
	for (var i = 'function' == typeof require && require, l = 0; l < o.length; l++) n(o[l])
	return n
})(
	{
		1: [
			function (e, t, r) {
				;(function (e) {
					...
					var i = (function () {
						...
						s = { mediaDataSource: {}, config: {} },
						p = (function (e) {
							function r(e, n) {
								return t(this, r), (e = c(s, e)), o(this, (r.__proto__ || Object.getPrototypeOf(r)).call(this, e, n))
							}
							return (
								n(r, e),
								i(r, [
									{
										...
										value: function (e) {
											...
											var t = this.options_.mediaDataSource,
					...
					;(p.isSupported = function () {
						...
						(p.formats = { 'video/flv': 'FLV', 'video/x-flv': 'FLV' }),
