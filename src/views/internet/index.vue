      ...
      <div class="toolsbar">
        <el-form class="el-form--inline" style="margin-bottom: 5px">
          ...
          <el-form-item>
            ...
            <!--<el-button type="success"><i class="el-icon-thumb"></i>手动执行</el-button>-->
            <el-button
              type="success"
              @click="loadList"
...
<script>
//	import controdetail from './details/controdetail'
export default {
  //		components: {
  //			'controdetail': controdetail
  //		},
  data() {
    return {
      soso: [
    ...
    async loadTask() {
      ...
      if (this.tableData) {
        for (let item of this.tableData) {
          ...
          //任务记录按钮状态
          let recordSun =
            parseInt(item.cnt_autorun) + parseInt(item.cnt_manual);
          if (recordSun == 0) {
